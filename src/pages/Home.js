  ...
  return (
    <div className='main h-[100vh] bg-[#FFFAFA]'>
      <div className='lady h-[40vh] relative flex flex-row-reverse bg-[#41C0AB] overflow-hidden z-[2] '>
        <img src={Lady} className='img w-full h-[111%] absolute right-[-100px] top-[-10%] overflow-x-hidden z-[-1]'></img>
      </div>
      <div className='login bg-[#FFFAFA] h-[50vh] flex items-center flex-col'>
        ...
        <form className='inputs  h-auto w-[80%] mt-4 inline-flex flex-col  items-start gap-6'>
          ...
          <div className=' input2 w-full flex flex-col justify-center items-start gap-[0.7rem]'>
